...
def cmd_run(args: argparse.Namespace) -> int:
    _, exit_code = pipeline.run(
        ...
        min_interval_hours=args.interval_hours,
...
def main(argv: list[str] | None = None) -> int:
    ...
    p_run.add_argument("--interval-hours", type=float, default=10.0,
                       help="minimum hours between update documents (default 10)")
    p_run.add_argument("--run-number", default="")
